...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <div id="menu">
			<ul>
                <li><a href="resident_home.jsp" class="current">Home</a></li>
                <li><a href="maintenance-request.jsp">Maintenance Request</a></li>
                <li><a href="view-request.jsp">View Request</a></li>
