...
<!-- search box-->
        ...
        <div class="sidebar_box">
        	...
        	<div class="sidebar_content">
                    ...
                    <table width="243" height="94" >
  <tr>
    <td><select name="usert" value="">
  ...
  <tr>
    ...
    <td><input type="text" name="userid" value="Username/Resident No."  onfocus="clearText(this)" onblur="clearText(this)" /> </td>
  </tr>
  <tr>
    <td><input type="password" name="pass" value="Password"  onfocus="clearText(this)" onblur="clearText(this)" /></td>
    <td><input type="submit" name="submit" value="login" id="btn_login"/></td>
  </tr>
</table>
			   </form>
...
<div class="content_box">
    <h2>Registration</h2>
      ...
      <div id="menu1">
            <ul>
                <li><a href="register.jsp" class="current">Resident</a></li>
                <li><a href="admin.jsp">Admin</a></li>
                <li><a href="maint.jsp">Maintainer</a></li>
             </ul>    	
            <div class="cleaner"></div>
        </div> <!-- end of menu -->    
        ...
        <form  name="regform" action="controller_jsp/do-registration.jsp" method="post" onsubmit="return regValidate()">
   
       <table width="600" height="371" border="0" class="regtable" cellspacing="4px">
    <tr>
    <td>
        <input class="input" type="hidden" id="usertype" name="usert" value="resid" readonly="readonly" />
      </td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td><select id="ap_num" name="ap_num" class="input">
            <option value="">Select</option>
           <%for(int i=1;i<1001;i++){ %>
           <option value="<%=i %>">Apartment No. <%=i %></option>
           <% } %>
        </select></td>
  </tr>
  <tr>
