    ...
    <h2>Registration</h2>
      <div id="menu1">
       ...
       <!-- end of menu -->    
        ...
        <form   action="controller_jsp/do-registration.jsp" method="post" onsubmit="return regValidatea()">
                <table width="600" height="371" border="0" class="regtable" cellspacing="4px">
    <tr>
    <td>
        <input class="input" type="hidden" id="usertype" name="usert" value="admin" readonly="readonly" />
    </td>
    </tr>
  <tr>
